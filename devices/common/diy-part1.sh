...
git_sparse_clone openwrt-21.02 "https://github.com/immortalwrt/packages" "feeds/packages/net/smartdns_pkg" net/smartdns

rm -rf feeds/packages/net/adguardhome
git_sparse_clone openwrt-21.02 "https://github.com/immortalwrt/packages" "feeds/packages/net/adguardhome_pkg" net/adguardhome
...
git_sparse_clone openwrt-21.02 "https://github.com/immortalwrt/luci" "feeds/luci/applications/smartdns_luci" applications/luci-app-smartdns
...
cp $GITHUB_WORKSPACE/devices/common/patches/luci-base/* feeds/luci/modules/luci-base/patches
...
cp $GITHUB_WORKSPACE/devices/common/patches/luci-app-wizard/* feeds/x/luci-app-wizard/patches

rm -rf feeds/x/luci-app-natcap/files/luci/controller/natcap.lua
cp $GITHUB_WORKSPACE/devices/common/packages/luci-app-natcap/natcap.lua feeds/x/luci-app-natcap/files/luci/controller/
...
chmod +x $GITHUB_WORKSPACE/devices/common/convert_translation.sh
bash $GITHUB_WORKSPACE/devices/common/convert_translation.sh -a >/dev/null 2>&1
